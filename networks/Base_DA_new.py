"""
Baseline = Resnet + psp + decoder
input_size=(256,128),
PA=85.01, mPA=57.52, mIoU=46.92
"""
...
class Decoder_Module(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(64, 32, kernel_size=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(32)
        )
        self.conv2 = nn.Sequential(
            nn.Conv2d(256, 96, kernel_size=1, stride=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(96)
        )
        self.conv3 = nn.Sequential(
            nn.Conv2d(128, 64, kernel_size=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(64),
            nn.Conv2d(64, 64, kernel_size=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(64)
        )
        ...
        self.conv4 = nn.Conv2d(64, num_classes, kernel_size=1, padding=0, dilation=1, bias=True)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.dual_attn = DANetHead(512, 64)
