...
class Decoder_Module(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.conv3 = nn.Sequential(
            ...
            InPlaceABNSync(32),
            nn.Conv2d(32, 32, kernel_size=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(32)
        )
        ...
        self.conv4 = nn.Conv2d(32, num_classes, kernel_size=1, padding=0, dilation=1, bias=True)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.dual_attn = DANetHead(256, 32)

        self.edge_layer = Edge_Module()

        self.layer7 = nn.Sequential(
            nn.Conv2d(800, 256, kernel_size=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(256),
            nn.Dropout2d(0.1),
