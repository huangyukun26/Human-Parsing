...
class Decoder_Module(nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(256, 128, kernel_size=1, stride=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(128)
        )
        self.conv3 = nn.Sequential(
            nn.Conv2d(160, 128, kernel_size=1, padding=0, dilation=1, bias=False),
            InPlaceABNSync(128),
        ...
        self.conv4 = nn.Conv2d(128, num_classes, kernel_size=1, padding=0, dilation=1, bias=True)
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        ...
        edge, edge_fea = self.edge_layer(f2, f3, f4)  # edge_fea:256*3=768
