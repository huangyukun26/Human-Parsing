...
from networks.Base_DA import Res_Deeplab
...
parser.add_argument("--snapshot_dir", type=str, default='./snapshots_256_256/base_da_bs8/',
                    help="Where to save snapshots of the model.")
parser.add_argument("--gpu", type=str, default='3', help="choose gpu device.")
parser.add_argument("--input-size", type=str, default='256,256',
