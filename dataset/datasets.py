...
class LIPDataSet(data.Dataset):
    def __init__(self, root, dataset, crop_size=[473, 473], scale_factor=0.25,
        ...
        list_path = os.path.join(self.root, self.dataset, 'id.txt')
    ...
    def __getitem__(self, index):
        ...
        im_path = os.path.join(self.root, self.dataset, 'image', im_name + '.jpg')
        parsing_anno_path = os.path.join(self.root, self.dataset, 'gt', im_name + '.png')
        # edge_anno_path = os.path.join(self.root, self.dataset, 'gt_edge', im_name+'.png')
        ...
        if self.dataset != 'train':
            ...
            # label_edge = cv2.imread(edge_anno_path, cv2.IMREAD_GRAYSCALE)
